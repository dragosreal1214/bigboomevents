...
- **Ordinea în shop**: `products.sort_order` + sortarea `recomandat`, care e **implicită** (`validation.js`, `listProducts`, `public/js/shop.js` — toate trei). Expresia e `(sort_order = 0), sort_order, name`, ca produsele neordonate să cadă la FINAL, nu la început. Blocuri: florărie 100–900, baloane 1000+ (cifre 2000, litere 3000, figurine 4000, accesorii 7000+).
