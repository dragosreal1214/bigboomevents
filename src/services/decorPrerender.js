...
// In productie paginile stau in directorul servit de nginx (WEB_DIR), nu in
// aplicatie — la fel ca la pageEditor.js. Fara asta, re-randarea declansata
// din panou ar scrie intr-un director inexistent.
const publicDir =
  config.webDir || join(dirname(fileURLToPath(import.meta.url)), '..', '..', 'public');
